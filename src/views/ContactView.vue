          ...
          <div class="lg:w-1/2 p-8">
            ...
            <form @submit.prevent="handleSubmit">
              <div class="mb-4">
                ...
                <input type="text" id="name" v-model="form.name" class="w-full border rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="Votre nom">
              </div>
              <div class="mb-4">
                <label for="email" class="block text-gray-700 font-semibold">Email</label>
                <input type="email" id="email" v-model="form.email" class="w-full border rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="Votre email">
              </div>
              <div class="mb-4">
                <label for="message" class="block text-gray-700 font-semibold">Message</label>
                <textarea id="message" v-model="form.message" rows="5" class="w-full border rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="Votre message"></textarea>
              </div>
  ...
  export default {
    data() {
      return {
        ...
        isModalVisible: false, // Contrôle l'affichage de la popup
      };
    },
    methods: {
      handleSubmit() {
        ...
        .then(response => {
          this.isModalVisible = true; // Affiche la popup
